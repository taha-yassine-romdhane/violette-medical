    ...
    <div>
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex gap-2">
          <button onClick={() => setTreeMgrOpen(true)} className="px-3 py-2.5 border border-gray-300 text-gray-700 rounded-xl hover:bg-gray-50 hover:text-gray-900 transition-colors text-sm font-medium flex items-center gap-1.5" title="Gérer l'arborescence">
      ...
      <div className="mb-5 space-y-3">
        <div className="flex gap-2">
          ...
          <div className="relative flex-1 max-w-md">
            ...
            />
            {search && (
              <button onClick={() => setSearch("")} className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-500 hover:text-gray-900 transition-colors">
              ...
              <div className="flex items-center gap-1.5 border-l border-gray-200 pl-3 ml-1">
                ...
                {outCount > 0 && (
                  <button
                    ...
                    className={`inline-flex items-center gap-1 px-2.5 py-1.5 rounded-lg text-xs font-medium transition-colors ${
                      stockFilter === "out" ? "bg-red-100 text-red-800 ring-1 ring-red-300" : "text-red-700 bg-red-50 hover:bg-red-100"
                    }`}
                  >
                ...
                {lowCount > 0 && (
                  <button
                    ...
                    className={`inline-flex items-center gap-1 px-2.5 py-1.5 rounded-lg text-xs font-medium transition-colors ${
                      stockFilter === "low" ? "bg-amber-100 text-amber-800 ring-1 ring-amber-300" : "text-amber-700 bg-amber-50 hover:bg-amber-100"
                    }`}
                  >
                ...
                {featCount > 0 && (
                  <button
                    ...
                    className={`inline-flex items-center gap-1 px-2.5 py-1.5 rounded-lg text-xs font-medium transition-colors ${
                      statusFilter === "featured" ? "bg-gray-900 text-white ring-1 ring-gray-900" : "text-gray-700 bg-gray-100 hover:bg-gray-200"
                    }`}
                  >
        ...
        {filtersOpen && (
          <div className="admin-card p-4">
            <div className="flex items-center justify-between mb-3">
              <p className="text-xs font-semibold text-gray-500 uppercase tracking-wide">Filtres avancés</p>
              {activeFilterCount > 0 && (
                <button onClick={clearAllFilters} className="text-xs text-gray-900 hover:text-gray-600 font-medium flex items-center gap-1">
            ...
            <div className="grid grid-cols-5 gap-3">
              {/* Category */}
              <div>
                <label className="block text-[11px] text-gray-500 mb-1">Catégorie</label>
                <select
                  value={catFilter}
              ...
              {/* Family */}
              <div>
                <label className="block text-[11px] text-gray-500 mb-1">Famille</label>
                <select
                  value={famFilter}
              ...
              {/* Subfamily */}
              <div>
                <label className="block text-[11px] text-gray-500 mb-1">Sous-famille</label>
                <select
                  value={sfFilter}
              ...
              <div className="flex flex-wrap gap-1.5 mt-3 pt-3 border-t border-gray-200">
                {catFilter && (
                  <span className="inline-flex items-center gap-1 px-2.5 py-1 bg-gray-900 text-white text-xs font-medium rounded-full">
                    ...
                    <button onClick={() => { setCatFilter(""); setFamFilter(""); setSfFilter(""); }} className="hover:text-gray-700">
                      <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" /></svg>
                    </button>
                  </span>
                )}
                {famFilter && (
                  <span className="inline-flex items-center gap-1 px-2.5 py-1 bg-blue-50 text-blue-700 text-xs font-medium rounded-full">
                    ...
                    <button onClick={() => { setFamFilter(""); setSfFilter(""); }} className="hover:text-blue-900">
                      <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" /></svg>
                    </button>
                  </span>
                )}
                {sfFilter && (
                  <span className="inline-flex items-center gap-1 px-2.5 py-1 bg-emerald-50 text-emerald-700 text-xs font-medium rounded-full">
                    ...
                    <button onClick={() => setSfFilter("")} className="hover:text-emerald-900">
                      <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" /></svg>
                    </button>
                  </span>
                )}
                {statusFilter && (
                  <span className="inline-flex items-center gap-1 px-2.5 py-1 bg-gray-100 text-gray-700 text-xs font-medium rounded-full">
                    ...
                    <button onClick={() => setStatusFilter("")} className="hover:text-gray-900">
                      <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" /></svg>
                    </button>
                  </span>
                )}
                {stockFilter && (
                  <span className={`inline-flex items-center gap-1 px-2.5 py-1 text-xs font-medium rounded-full ${
                    stockFilter === "out" ? "bg-red-50 text-red-700" : stockFilter === "low" ? "bg-amber-50 text-amber-700" : "bg-emerald-50 text-emerald-700"
                  }`}>
        ...
        <table className="w-full">
          ...
          <tbody className="divide-y divide-gray-100">
            {filteredProducts.length === 0 ? (
              <tr><td colSpan={8} className="px-6 py-8 text-center text-gray-500">{products.length === 0 ? "Aucun produit." : "Aucun produit ne correspond aux filtres."}</td></tr>
            ) : (
              filteredProducts.map((p) => (
                <tr key={p.id} className="hover:bg-gray-50 transition-colors">
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        {p.isFeatured && <span className="text-[10px] text-gray-700 font-medium">En vedette</span>}
                      </div>
                    </div>
                  </td>
                  ...
                  <td className="px-6 py-4 text-sm text-gray-900 font-medium tabular-nums">{p.priceHT.toFixed(2)}</td>
                  <td className="px-6 py-4 text-sm text-gray-900 font-medium tabular-nums">{p.priceTTC.toFixed(2)}</td>
                  <td className="px-6 py-4">
                    <span className={`text-sm font-medium ${p.stock <= 0 ? "text-red-600" : p.stock <= p.minStock ? "text-amber-600" : "text-emerald-600"}`}>
                      {p.stock}
                    </span>
                  </td>
                  <td className="px-6 py-4">
                    <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${p.isActive ? "bg-emerald-50 text-emerald-700" : "bg-red-50 text-red-700"}`}>
                      {p.isActive ? "Actif" : "Inactif"}
                    </span>
                  </td>
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-1">
                      <button onClick={() => openEdit(p)} title="Modifier" className="w-8 h-8 rounded-lg flex items-center justify-center text-gray-500 hover:text-gray-900 hover:bg-gray-100 transition-colors">
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" /></svg>
                      </button>
                      <button onClick={() => handleDelete(p.id)} title="Supprimer" className="w-8 h-8 rounded-lg flex items-center justify-center text-gray-500 hover:text-red-600 hover:bg-red-50 transition-colors">
      ...
      {/* ========== PRODUCT DIALOG ========== */}
      <dialog ref={dialogRef} onClose={() => setDialogOpen(false)} className="fixed inset-0 m-auto w-full max-w-3xl h-fit max-h-[92vh] rounded-2xl border border-gray-200 bg-white text-gray-700 p-0 shadow-2xl shadow-gray-900/10 backdrop:bg-gray-900/40 backdrop:backdrop-blur-sm">
        <div className="flex flex-col max-h-[92vh]">
          ...
          <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200 shrink-0">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-base font-semibold text-gray-900">{editingId ? "Modifier le produit" : "Nouveau produit"}</h2>
                <p className="text-xs text-gray-500">Remplissez les informations du produit</p>
              </div>
            </div>
            <div className="flex items-center gap-2">
              <label className="flex items-center gap-1.5 cursor-pointer mr-2">
                <div className={`relative w-8 h-[18px] rounded-full transition-colors ${formData.isActive ? "bg-emerald-500" : "bg-gray-300"}`}>
              ...
              <label className="flex items-center gap-1.5 cursor-pointer mr-3" title="Chaque unité de ce produit possède un numéro de série (désactivez pour les accessoires)">
                <div className={`relative w-8 h-[18px] rounded-full transition-colors ${formData.trackSerial ? "bg-blue-500" : "bg-gray-300"}`}>
                ...
                <span className="text-xs font-medium text-gray-700">N° de série</span>
              </label>
              <label className="flex items-center gap-1.5 cursor-pointer mr-3">
                <div className={`relative w-8 h-[18px] rounded-full transition-colors ${formData.isFeatured ? "bg-gray-900" : "bg-gray-300"}`}>
                ...
                <span className="text-xs font-medium text-gray-700">Vedette</span>
              </label>
              <button onClick={() => setDialogOpen(false)} className="w-8 h-8 rounded-lg flex items-center justify-center text-gray-500 hover:text-gray-900 hover:bg-gray-100 transition-colors">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" /></svg>
              </button>
            </div>
          </div>

          {error && <div className="mx-6 mt-4 bg-red-50 border border-red-200 text-red-700 px-4 py-2.5 rounded-xl text-sm">{error}</div>}
          ...
          <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto">
            <div className="p-6 space-y-5">
              ...
              {/* Names */}
              <div>
                <label className="block text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2">Nom du produit</label>
              ...
              <div className="bg-blue-50 rounded-xl p-4 border border-blue-200">
                <label className="block text-xs font-semibold text-blue-700 uppercase tracking-wide mb-3">Classification</label>
                <div className="grid grid-cols-3 gap-3">
                  ...
                  <div>
                    <label className="block text-xs text-gray-500 mb-1">Famille</label>
                  ...
                  <div>
                    <label className="block text-xs text-gray-500 mb-1">Sous-famille</label>
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  <label className="block text-xs font-semibold text-gray-500 uppercase tracking-wide">Référence</label>
                  <div className="flex bg-gray-100 rounded-md p-0.5">
                    <button type="button" onClick={() => setRefMode("auto")} className={`px-2 py-0.5 text-[10px] font-semibold rounded transition-colors ${refMode === "auto" ? "bg-purple-600 text-white shadow-sm" : "text-gray-500 hover:text-gray-900"}`}>Auto</button>
                    <button type="button" onClick={() => { setRefMode("manual"); if (!formData.reference) set("reference", autoRef); }} className={`px-2 py-0.5 text-[10px] font-semibold rounded transition-colors ${refMode === "manual" ? "bg-purple-600 text-white shadow-sm" : "text-gray-500 hover:text-gray-900"}`}>Manuel</button>
                  </div>
                </div>
                {refMode === "auto" ? (
                  <div className="w-full px-3 py-2.5 border border-gray-200 rounded-xl text-sm font-mono bg-gray-50 text-gray-700 flex items-center justify-between">
              ...
              <div className="bg-gray-50 rounded-xl p-4 border border-gray-200">
                <div className="grid grid-cols-5 gap-3">
                  <div>
                    <label className="block text-xs text-gray-500 mb-1">Prix HT *</label>
                  ...
                  <div>
                    ...
                    <div className="w-full px-3 py-2 border border-gray-200 rounded-xl text-sm font-semibold bg-gray-50 text-gray-900 tabular-nums">
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  <label className="block text-xs font-semibold text-gray-500 uppercase tracking-wide">Images</label>
                  <button type="button" onClick={addImageUrl} className="text-xs text-gray-900 hover:text-gray-600 font-medium flex items-center gap-1">
                ...
                <div
                  ...
                  className={`border-2 border-dashed rounded-xl p-4 text-center cursor-pointer transition-all ${dragOver ? "border-gray-500 bg-gray-100" : "border-gray-300 hover:border-gray-400 hover:bg-gray-50"}`}
                >
                  <input ref={fileInputRef} type="file" accept="image/*" multiple onChange={(e) => handleFiles(e.target.files)} className="sr-only" />
                  <div className="flex items-center justify-center gap-3">
                    <div className={`w-10 h-10 rounded-lg flex items-center justify-center transition-colors ${dragOver ? "bg-gray-200" : "bg-gray-100"}`}>
                      <svg className={`w-5 h-5 ${dragOver ? "text-gray-700" : "text-gray-500"}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {/* Sticky footer */}
            <div className="sticky bottom-0 bg-white border-t border-gray-200 px-6 py-3 flex items-center justify-between shrink-0">
              <div className="flex items-center gap-2 text-xs text-gray-500">
                {imageList.length > 0 && <span className="inline-flex items-center gap-1 bg-gray-100 text-gray-700 px-2 py-1 rounded-md font-medium">{imageList.length} image(s)</span>}
                {formData.priceHT && <span className="inline-flex items-center gap-1 bg-emerald-50 text-emerald-700 px-2 py-1 rounded-md font-medium">{priceTTC} TND</span>}
              </div>
              <div className="flex items-center gap-3">
                <button type="button" onClick={() => setDialogOpen(false)} className="px-4 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-50 hover:text-gray-900 rounded-xl transition-colors">Annuler</button>
      ...
      {/* ========== TREE MANAGER DIALOG ========== */}
      <dialog ref={treeMgrRef} onClose={() => { setTreeMgrOpen(false); setAddingTo(null); setEditingNode(null); }} className="fixed inset-0 m-auto w-full max-w-2xl h-fit max-h-[85vh] rounded-2xl border border-gray-200 bg-white text-gray-700 p-0 shadow-2xl shadow-gray-900/10 backdrop:bg-gray-900/40 backdrop:backdrop-blur-sm">
        <div className="flex flex-col max-h-[85vh]">
          <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200 shrink-0">
            <div>
              <h2 className="text-base font-semibold text-gray-900">Arborescence produits</h2>
              <p className="text-xs text-gray-500">Catégories, familles et sous-familles</p>
            </div>
            <div className="flex items-center gap-2">
              <button type="button" onClick={() => { setAddingTo({ type: "category" }); setAddForm({ nameFr: "", nameEn: "" }); }} className="btn-primary px-3 py-1.5 text-xs">
                + Catégorie
              </button>
              <button onClick={() => { setTreeMgrOpen(false); setAddingTo(null); setEditingNode(null); }} className="w-8 h-8 rounded-lg flex items-center justify-center text-gray-500 hover:text-gray-900 hover:bg-gray-100 transition-colors">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" /></svg>
              </button>
            </div>
          </div>
          ...
          <div className="flex-1 overflow-y-auto p-4">
            ...
            {addingTo?.type === "category" && !addingTo.parentId && (
              <form onSubmit={handleAddNode} className="mb-4 p-3 bg-gray-50 rounded-xl border border-gray-300">
                ...
                <div className="flex justify-end gap-2">
                  <button type="button" onClick={() => setAddingTo(null)} className="px-3 py-1.5 text-xs text-gray-500 hover:bg-gray-50 hover:text-gray-900 rounded-md transition-colors">Annuler</button>
                  <button type="submit" className="px-3 py-1.5 text-xs bg-purple-600 text-white rounded-md hover:bg-purple-700 transition-colors">Créer</button>
                </div>
              </form>
            )}

            {categories.length === 0 && !addingTo ? (
              <p className="text-sm text-gray-500 text-center py-8">Aucune catégorie. Commencez par en créer une.</p>
            ) : (
                ...
                {categories.map((cat) => {
                  ...
                  return (
                    <div key={cat.id} className="rounded-xl border border-gray-200 overflow-hidden">
                      {/* Category row */}
                      {isEditingCat ? (
                        <form onSubmit={handleEditNode} className="p-3 bg-gray-50">
                          <div className="grid grid-cols-2 gap-2 mb-2">
                          ...
                          <div className="flex justify-end gap-2">
                            <button type="button" onClick={() => setEditingNode(null)} className="px-3 py-1.5 text-xs text-gray-500 hover:bg-gray-50 hover:text-gray-900 rounded-md transition-colors">Annuler</button>
                            <button type="submit" className="px-3 py-1.5 text-xs bg-purple-600 text-white rounded-md hover:bg-purple-700 transition-colors">Enregistrer</button>
                          </div>
                        </form>
                      ) : (
                        <div className="flex items-center justify-between px-4 py-3 hover:bg-gray-50 cursor-pointer transition-colors" onClick={() => toggleCatExpanded(cat.id)}>
                          <div className="flex items-center gap-3">
                          ...
                          <div className="flex items-center gap-1" onClick={(e) => e.stopPropagation()}>
                            <button onClick={() => { setAddingTo({ type: "family", parentId: cat.id }); setAddForm({ nameFr: "", nameEn: "" }); setExpandedCats((prev) => new Set(prev).add(cat.id)); }} className="w-7 h-7 rounded-md flex items-center justify-center text-gray-500 hover:text-emerald-600 hover:bg-emerald-50 transition-colors" title="Ajouter une famille">
                              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" /></svg>
                            </button>
                            <button onClick={() => { setEditingNode({ type: "category", id: cat.id }); setEditNodeForm({ nameFr: cat.nameFr, nameEn: cat.nameEn }); }} className="w-7 h-7 rounded-md flex items-center justify-center text-gray-500 hover:text-gray-900 hover:bg-gray-100 transition-colors" title="Modifier">
                            ...
                            {totalProducts === 0 && cat.families.length === 0 && (
                              <button onClick={() => handleDeleteNode("category", cat.id)} className="w-7 h-7 rounded-md flex items-center justify-center text-gray-500 hover:text-red-600 hover:bg-red-50 transition-colors" title="Supprimer">
                      ...
                      {isExpanded && (
                        <div className="border-t border-gray-200 bg-gray-50">
                          ...
                          {addingTo?.type === "family" && addingTo.parentId === cat.id && (
                            <form onSubmit={handleAddNode} className="mx-4 my-2 p-3 bg-blue-50 rounded-lg border border-blue-200">
                              <p className="text-[11px] font-semibold text-blue-700 mb-2">Nouvelle famille dans {cat.nameFr}</p>
                              <div className="grid grid-cols-2 gap-2 mb-2">
                              ...
                              <div className="flex justify-end gap-2">
                                <button type="button" onClick={() => setAddingTo(null)} className="px-3 py-1 text-xs text-gray-500 hover:bg-gray-50 hover:text-gray-900 rounded-md transition-colors">Annuler</button>
                                <button type="submit" className="px-3 py-1 text-xs bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors">Créer</button>
                              </div>
                            </form>
                          )}
                          ...
                          {cat.families.map((fam) => {
                            ...
                            return (
                              <div key={fam.id}>
                                {isEditingFam ? (
                                  <form onSubmit={handleEditNode} className="mx-4 my-1 p-3 bg-blue-50 rounded-lg">
                                    <div className="grid grid-cols-2 gap-2 mb-2">
                                    ...
                                    <div className="flex justify-end gap-2">
                                      <button type="button" onClick={() => setEditingNode(null)} className="px-3 py-1 text-xs text-gray-500 hover:bg-gray-50 hover:text-gray-900 rounded-md transition-colors">Annuler</button>
                                      <button type="submit" className="px-3 py-1 text-xs bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors">Enregistrer</button>
                                    </div>
                                  </form>
                                ) : (
                                  <div className="flex items-center justify-between px-4 py-2.5 pl-10 hover:bg-gray-50 cursor-pointer transition-colors" onClick={() => toggleFamExpanded(fam.id)}>
                                    <div className="flex items-center gap-2.5">
                                      <svg className={`w-3.5 h-3.5 text-gray-500 transition-transform ${isFamExpanded ? "rotate-90" : ""}`} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" /></svg>
                                      <div className="w-6 h-6 rounded-md bg-blue-50 flex items-center justify-center text-[10px] font-bold text-blue-700">
                                        {fam.nameFr.charAt(0).toUpperCase()}
                                      </div>
                                      <div>
                                        <p className="text-sm font-medium text-gray-800">{fam.nameFr}</p>
                                        <p className="text-[10px] text-gray-500">{fam.nameEn} &middot; {famProducts} prod. &middot; {fam.subfamilies.length} s-fam.</p>
                                      </div>
                                    </div>
                                    <div className="flex items-center gap-1" onClick={(e) => e.stopPropagation()}>
                                      <button onClick={() => { setAddingTo({ type: "subfamily", parentId: fam.id }); setAddForm({ nameFr: "", nameEn: "" }); setExpandedFams((prev) => new Set(prev).add(fam.id)); }} className="w-6 h-6 rounded flex items-center justify-center text-gray-500 hover:text-emerald-600 hover:bg-emerald-50 transition-colors" title="Ajouter sous-famille">
                                        <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" /></svg>
                                      </button>
                                      <button onClick={() => { setEditingNode({ type: "family", id: fam.id }); setEditNodeForm({ nameFr: fam.nameFr, nameEn: fam.nameEn }); }} className="w-6 h-6 rounded flex items-center justify-center text-gray-500 hover:text-gray-900 hover:bg-gray-100 transition-colors" title="Modifier">
                                      ...
                                      {famProducts === 0 && fam.subfamilies.length === 0 && (
                                        <button onClick={() => handleDeleteNode("family", fam.id)} className="w-6 h-6 rounded flex items-center justify-center text-gray-500 hover:text-red-600 hover:bg-red-50 transition-colors" title="Supprimer">
                                ...
                                {isFamExpanded && (
                                  <div className="ml-16 border-l-2 border-gray-200">
                                    ...
                                    {addingTo?.type === "subfamily" && addingTo.parentId === fam.id && (
                                      <form onSubmit={handleAddNode} className="mx-3 my-1.5 p-2.5 bg-emerald-50 rounded-lg border border-emerald-200">
                                        <p className="text-[10px] font-semibold text-emerald-700 mb-1.5">Nouvelle sous-famille dans {fam.nameFr}</p>
                                        <div className="grid grid-cols-2 gap-2 mb-2">
                                        ...
                                        <div className="flex justify-end gap-2">
                                          <button type="button" onClick={() => setAddingTo(null)} className="px-2.5 py-1 text-xs text-gray-500 hover:bg-gray-50 hover:text-gray-900 rounded-md transition-colors">Annuler</button>
                                          <button type="submit" className="px-2.5 py-1 text-xs bg-emerald-600 text-white rounded-md hover:bg-emerald-700 transition-colors">Créer</button>
                                        </div>
                                      </form>
                                    )}
                                    ...
                                    {fam.subfamilies.map((sf) => {
                                      ...
                                      return isEditingSf ? (
                                        <form key={sf.id} onSubmit={handleEditNode} className="mx-3 my-1 p-2.5 bg-emerald-50 rounded-lg">
                                          <div className="grid grid-cols-2 gap-2 mb-2">
                                          ...
                                          <div className="flex justify-end gap-2">
                                            <button type="button" onClick={() => setEditingNode(null)} className="px-2.5 py-1 text-xs text-gray-500 hover:bg-gray-50 hover:text-gray-900 rounded-md transition-colors">Annuler</button>
                                            <button type="submit" className="px-2.5 py-1 text-xs bg-emerald-600 text-white rounded-md hover:bg-emerald-700 transition-colors">Enregistrer</button>
                                          </div>
                                        </form>
                                      ) : (
                                        <div key={sf.id} className="flex items-center justify-between px-4 py-2 hover:bg-gray-50 transition-colors">
                                          <div className="flex items-center gap-2">
                                            <div className="w-5 h-5 rounded bg-emerald-50 flex items-center justify-center text-[9px] font-bold text-emerald-700">
                                              {sf.nameFr.charAt(0).toUpperCase()}
                                            </div>
                                            <div>
                                              <p className="text-xs font-medium text-gray-800">{sf.nameFr}</p>
                                              <p className="text-[10px] text-gray-500">{sf.nameEn} &middot; {sfProducts} prod.</p>
                                            </div>
                                          </div>
                                          <div className="flex items-center gap-1">
                                            <button onClick={() => { setEditingNode({ type: "subfamily", id: sf.id }); setEditNodeForm({ nameFr: sf.nameFr, nameEn: sf.nameEn }); }} className="w-5 h-5 rounded flex items-center justify-center text-gray-500 hover:text-gray-900 transition-colors" title="Modifier">
                                              <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" /></svg>
                                            </button>
                                            {sfProducts === 0 && (
                                              <button onClick={() => handleDeleteNode("subfamily", sf.id)} className="w-5 h-5 rounded flex items-center justify-center text-gray-500 hover:text-red-600 transition-colors" title="Supprimer">
                                                <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" /></svg>
                                              </button>
                                            )}
                                          </div>
