          ...
          <Reveal delay={200}>
            <div className="flex items-center gap-2 shrink-0">
              <button
                ...
                className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-white border border-gray-200 flex items-center justify-center text-gray-500 hover:text-gray-900 hover:border-gray-400 active:scale-95 transition-all"
              >
